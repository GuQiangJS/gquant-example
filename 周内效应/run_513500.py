...
BENCHMARK_CODE='GSPC' 
START='2013-12-05'
END='2021-05-06' #截止日期。更新时需要使用yfinance获取数据。https://pypi.org/project/yfinance/
...
print("'2021-05-06' #指数截止日期。更新时需要使用yfinance获取数据。https://pypi.org/project/yfinance/")

full_benchmark_data = pd.read_csv('/amount_volume_jupyter/gspc.csv',encoding='utf-8')
full_benchmark_data['date']=pd.to_datetime(full_benchmark_data['Date'])
full_benchmark_data.rename(columns={'Open':'open', 'High':'high','Low':'low','Close':'close','Volume':'volume'}, inplace = True)
