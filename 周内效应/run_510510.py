...
CODE='510510' #计算数据.南方中证500ETF
BENCHMARK_CODE='000905' #基准代码
START='2013-04-11'
...
i=1
while i<=20:
    report = MonteCarloTest(full_data, full_benchmark_data,times=100000,multiprocessing=True)
    report.to_csv('/amount_volume_jupyter/Result_{}_100000_{}.csv'.format(CODE,i))
    i=i+1